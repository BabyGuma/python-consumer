...
uri = "mongodb+srv://babyguma:GUMG990514@cluster0.c0toty4.mongodb.net/?retryWrites=true&w=majority"
...
consumer = KafkaConsumer('test',bootstrap_servers=[
     'my-kafka-0.my-kafka-headless.babyguma.svc.cluster.local:9092'
    ])
